    ...
    <div className="home-container">
      ...
      <div className="card">
        <p>
          ...
          no decir impide, la investigación.&quot;
        </p>
      </div>

      <div className="card">
        <p>
          &quot;La Historia no puede resolverse sin acudir a los archivos. No es
          suficiente un conocimiento superficial o aproximado, por lo tanto es
          obligatorio consultar e interpretar los documentos de la época del
          lugar que se pretende investigar.&quot;
        </p>
      </div>
